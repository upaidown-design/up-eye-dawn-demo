...
const rows = {
  ...
  WORKFLOW_TEST_PORTAL_ENABLED: previous.WORKFLOW_TEST_PORTAL_ENABLED || 'false',
  ...
  ADMIN_MFA_ENCRYPTION_KEY: stableSecret('ADMIN_MFA_ENCRYPTION_KEY', () => randomBytes(32).toString('hex')),
  TEMP_ADMIN_DEV_LOGIN_ENABLED: previous.TEMP_ADMIN_DEV_LOGIN_ENABLED || 'false',
  TEMP_ADMIN_DEV_LOGIN_TOKEN: previous.TEMP_ADMIN_DEV_LOGIN_TOKEN || '',
  TEMP_ADMIN_DEV_LOGIN_EXPIRES_AT: previous.TEMP_ADMIN_DEV_LOGIN_EXPIRES_AT || '',
  ...
  MAIL_SERVER_PROVIDER: previous.MAIL_SERVER_PROVIDER || 'STALWART',
